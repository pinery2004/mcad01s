...
//
static MgMat3 GetBaseCoord( );					// 基準座標変換マトリックス
...
//
static MgMat3	GetCurCoord( );					// カレント座標変換マトリックス
...
//
static MgMat3 SetCurCoord(						// 直前のカレント座標変換マトリックス
...
static MINT	MdwTransMatrixViewToWorld(
						MDID		i_idWin,	// ウィンドウＩＤ
						MDID		i_idDB,		// DB座標系
						MgMat3*		o_pmatVtD	// 座標変換マトリックス(視点座標 -> DB座標)
				);
...
static MINT	MdwTransMatrixWorldToView(
						MDID		i_idDB,		// DB座標系
						MDID		i_idWin,	// ウィンドウＩＤ
						MgMat3*		o_pmatDtV	// 座標変換マトリックス(視点座標 -> DB座標)
				);
...
static MINT	MdwTransMatrixPixelToView(
						MDID		i_idWin,	// ウィンドウＩＤ
						MgMat3*		o_pmatPtV	// 座標変換マトリックス(pixel座標 -> 視点座標)
				);
...
static MINT	MdwTransMatrixViewToPixel(
						MDID		i_idWin,	// ウィンドウＩＤ
						MgMat3*		o_pmatVtP	// 座標変換マトリックス(視点座標 -> pixel座標)
				);
...
static MINT	MdwGetEyeCoord(
						MDID		i_idWin,	// ウィンドウＩＤ
						MgMat3*		o_pmatV		// 視点座標変換マトリックス（基準座標系での値）
				);
...
static MINT	MdwSetEyeCoord(
						MDID		i_idWin,	// ウィンドウＩＤ
						MgMat3*		i_pmatV		// 視点座標変換マトリックス（基準座標系での値）
				);
...
static MINT	MdwGetTempPlaneCoord(
						MDID		i_idWFn,	// ウィンドウ機能番号
						MgMat3*		o_pmatV		// 作業面の座標系の座標変換マトリックス
												// （基準座標系での値）
				);
...
static MINT	MdwSetTempPlaneCoord(
						MDID		i_idWFn,	// ウィンドウ機能番号
						MgMat3*		i_pmatV		// 作業面の座標系の座標変換マトリックス
												// （基準座標系での値）
				);
