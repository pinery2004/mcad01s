/* F:\MCADDEV\PRJ\LIB\MCADLIB\MCADDEF.H
...
const MREAL		INCHES_TO_MM	= (MREAL)25.4;
const MREAL		IC_PI			= (MREAL)3.14159265358979323846;
const MREAL		IC_TWOPI		= (MREAL)(2. * IC_PI);

inline MREAL InchesToMm( MREAL inches)
	{ return inches * INCHES_TO_MM;}

inline MREAL MmToInches( MREAL millimeters)
...
#define IC_MAXACADVER IC_ACAD2000

// defines for sysvarlinks, anders with the "spl" field

#define IC_SYSVARFLAG_UNUSUAL					0x0001
#define IC_SYSVARFLAG_SPECIALHANDLING			0x0002
#define IC_SYSVARFLAG_UNDOCUMENTED				0x0004
#define IC_SYSVARFLAG_SPECIALSOURCE				0x0008
#define IC_SYSVARFLAG_SPECIALRANGE				0x0010
#define IC_SYSVARFLAG_DONTDXFOUT  				0x0020
#define IC_SYSVARFLAG_REQUIRESSCREENCHANGE		0x0040
#define IC_SYSVARFLAG_ACADSESSIONVARTOHDR 		0x0080
#define IC_SYSVARFLAG_ANGLE  					0x0100
#define IC_SYSVARFLAG_TIMEDATE        			0x0200
#define IC_SYSVARFLAG_DONTSAVEINUNDOLIST 		0x0400
#define IC_SYSVARFLAG_SPECIALVIEWVBL			0x0800
#define IC_SYSVARFLAG_NEWR13VBL   				0x1000
#define IC_SYSVARFLAG_FILEPATH					0x2000
#define IC_SYSVARFLAG_USERREADONLY				0x4000
#define IC_SYSVARFLAG_UNSUPPORTED				0x8000
#define IC_SYSVARFLAG_PAPERSPACE			0x00010000

/*   Bit 0 : Unusual form in buffer */
/*   Bit 1 : Special handling writing; not independent */
/*   Bit 2 : Undocumented */
/*   Bit 3 : Special source (not stored in a buffer) */
/*             (like DATE).  Usually, truly read-only. */
/*             (Should be only certain session vars.) */
/*   Bit 4 : Special range of allowed vals */
/*   Bit 5 : Exclude from DXFOUT */
/*   Bit 6 : Requires some sort of screen change */
/*   Bit 7 : An ACAD session var that we moved to the */
/*             header (giving it a slot after the end */
/*             of the true R12 header).  This makes it */
/*             "per drawing" instead of "per session". */
/*   Bit 8 : Angle     ( it's "type" is RTREAL) */
/*   Bit 9 : Time-date ( it's "type" is RTREAL) */
/*   Bit 10: Don't save in undo list. */
/*   Bit 11: Special view variable (from VIEW table). */
/*   Bit 12: New variable in R13 (exclude from R12 DXFout) */
/*   Bit 13: A file pathname */
/*   Bit 14: User-read-only */
/*   Bit 15: A var that is currently unsupported. */
...
#define IC_UNDO_CMCADVIEW_CREATE   19
#define IC_UNDO_CMCADVIEW_SIZE     20
#define IC_UNDO_CMCADVIEW_MOVE     21
#define IC_UNDO_CMCADVIEW_DELETE   22
